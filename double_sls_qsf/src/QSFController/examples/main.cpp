...
#include "QSFController_terminate.h"
...
void main_QSFController()
{
  ...
  double dv2[4];
  double F[3];
  // Initialize function 'QSFController' input arguments.
  ...
  // Call the entry-point 'QSFController'.
  argInit_12x1_real_T(dv);
  argInit_1x10_real_T(dv1);
  argInit_1x4_real_T(dv2);
  QSFController(dv, dv1, dv2, ref_1_tmp, ref_1_tmp, ref_1_tmp, F);
}
